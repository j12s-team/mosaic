    ...
    <section id="loop" className="relative overflow-hidden">
      <div className="mx-auto max-w-content px-6 py-24">
        ...
        <div className="mt-16">
          <div className="relative grid gap-4 md:grid-cols-4">
            ...
            >
              <defs>
                <linearGradient id="line" x1="0" y1="0" x2="1" y2="0">
                  <stop offset="0%" style={{ stopColor: "rgb(var(--md-sys-color-primary))" }} stopOpacity={0} />
                  <stop offset="50%" style={{ stopColor: "rgb(var(--md-sys-color-primary))" }} stopOpacity={0.6} />
                  <stop offset="100%" style={{ stopColor: "rgb(var(--md-sys-color-primary))" }} stopOpacity={0} />
                </linearGradient>
              </defs>
            ...
            {NODES.map((n) => (
              <div key={n.title} className="relative flex flex-col items-center text-center">
                <div className="shadow-elevation-2 grid h-24 w-24 place-items-center rounded-lg border border-outline-variant bg-surface-container-low dark:bg-surface-container-low">
                  <n.icon className="h-7 w-7 text-primary" />
                </div>
                <h3 className="mt-5 text-base font-semibold">{n.title}</h3>
                <p className="mt-2 max-w-xs text-sm text-on-surface-variant">{n.body}</p>
          ...
          <div className="mx-auto mt-12 max-w-3xl rounded-lg border border-outline-variant bg-surface-container-low dark:bg-surface-container-low p-6">
