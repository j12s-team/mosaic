  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-5">
                ...
                <div className="text-right">
                  ...
                  <div className="text-[10px] text-muted-foreground">
                    {c.metrics.momentum30d !== undefined && (
                      <span
                        className={
                          c.metrics.momentum30d >= 0 ? "text-emerald-300" : "text-red-300"
                        }
                      >
        ...
        <div className="flex items-center justify-between rounded-lg border border-white/5 bg-background/40 p-3 text-xs">
          <div>
