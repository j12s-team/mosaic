    ...
    <Card>
      ...
      <CardContent>
        {loading ? (
          ...
          <div className="py-6 text-center text-xs text-on-surface-variant">No SSI indexes available right now.</div>
        ) : (
          <div className="grid gap-2 sm:grid-cols-2">
            {indexes.map((idx) => {
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-2 flex flex-wrap gap-1">
                        {idx.constituents.slice(0, 5).map((c) => (
                          <span
                            key={c.symbol}
                            className="rounded-sm border border-outline-variant bg-surface-container-low dark:bg-surface-container-low px-1.5 py-0.5 font-mono text-[10px]"
                          >
